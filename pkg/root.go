...
func NewRootCmd() *cobra.Command {
	rootCmd := &cobra.Command{
		Use:               "stash-etcd",
		Short:             `Etcd backup & restore plugin for Stash by AppsCode`,
		Long:              `Etcd backup & restore plugin for Stash by AppsCode. For more information, visit here: https://stash.run`,
	...
	rootCmd.AddCommand(NewCmdRestoreMember())
	rootCmd.AddCommand(NewCmdReplaceData())
